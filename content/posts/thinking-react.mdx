...
Here's the plan:
- First, we're going to pull apart all the little pieces that you find in a color picker.
- Then, piece by piece, we're going to build the component.
- Last, but certainly not least we will pick some *groovy* colors.
